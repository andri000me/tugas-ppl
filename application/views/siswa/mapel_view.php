                    ...
                    <tbody>
                        ...
                        <?php foreach ($mapel as $s) : ?>
                            <tr>
                                ...
                                <td><?= $s['mapel']; ?></td>
                                <td>
                                    <a href="<?= base_url('data/ubahMapel/') . $s['id']; ?>" class="badge badge-success">edit</a>
                                    |
                                    <a href="<?= base_url('data/hapusMapel/') . $s['id']; ?>" data-toggle="modal" data-target="#ubahData" class="badge badge-danger tombol-hapus-siswa">delete</a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('data/mapel') ?>" method="post">
